...
# ═══════════════════════════════════════════════════════════════════════════════
# Cullis Demo — ChipFactory (Manufacturer) Bootstrap
#
...
#   ORG_ID        — org identifier          (default: chipfactory)
#   AGENT_ID      — agent identifier        (default: chipfactory::sales)
#   VAULT_ADDR    — Vault address           (default: http://127.0.0.1:8200)
#   VAULT_TOKEN   — Vault token             (default: demo-mfr-token)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ── Defaults ─────────────────────────────────────────────────────────────────
ORG_ID="${ORG_ID:-chipfactory}"
AGENT_ID="${AGENT_ID:-chipfactory::sales}"
DISPLAY_NAME="${DISPLAY_NAME:-ChipFactory S.r.l.}"
AGENT_DISPLAY_NAME="${AGENT_DISPLAY_NAME:-Sales Agent}"
CAPABILITIES="${CAPABILITIES:-order.read,order.write,manufacturing}"

VAULT_ADDR="${VAULT_ADDR:-http://127.0.0.1:8200}"
VAULT_TOKEN="${VAULT_TOKEN:-demo-mfr-token}"
...
echo -e "  3. Start agent: docker compose up manufacturer"
echo ""
