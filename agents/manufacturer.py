"""
ChipFactory S.r.l. — Agente di vendita
...
Usage:
  python agents/manufacturer.py --config certs/chipfactory/sales/agent.env
"""
import argparse
import sys
...
# di ChipFactory S.r.l. Non modificare via .env.
# ─────────────────────────────────────────────

SYSTEM_PROMPT = """\
You are the sales agent for ChipFactory S.r.l., an Italian manufacturer of
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ChipFactory S.r.l. — Agente vendita")
